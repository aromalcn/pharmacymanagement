...
$expired = $db->query("SELECT COUNT(*) FROM medicines WHERE expiry_date <= CURDATE()")->fetchColumn();
...
<div class="container">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Welcome back, <strong><?= htmlspecialchars($_SESSION['admin_name']) ?></strong>! Here's your pharmacy overview.</p>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="padding:0;">
                <?php if (empty($expiring_meds)): ?>
                    <div class="empty-state"><div class="empty-icon">✅</div><p>No medicines expiring soon.</p></div>
                <?php else: ?>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="view_orders.php?id=<?= $o['id'] ?>">#<?= $o['id'] ?></a></td>
