...
$params = [];
$sql = "SELECT * FROM medicines WHERE expiry_date > CURDATE() AND stock_quantity > 0";
...
$categories = $db->query("SELECT DISTINCT category FROM medicines WHERE expiry_date > CURDATE() AND stock_quantity > 0")->fetchAll(PDO::FETCH_COLUMN);
